...
void GUITransform2D::Update(const Greet::Transform2DComponent& transform)
{
  // Translation
  transform2D->GetComponentByName<TextBox>("translationX")
...
void GUITransform2D::GUITextBoxTranslationX(Greet::Component* component,
...
void GUITransform2D::GUITextBoxTranslationY(Greet::Component* component,
                                              const std::string& before,
                                              const std::string& after)
{
  Entity e = entityManager->GetSelectedEntity();
...
void GUITransform2D::GUITextBoxScalingX(Greet::Component* component,
                                          const std::string& before,
                                          const std::string& after)
{
  Entity e = entityManager->GetSelectedEntity();
...
void GUITransform2D::GUITextBoxScalingY(Greet::Component* component,
                                          const std::string& before,
                                          const std::string& after)
{
  Entity e = entityManager->GetSelectedEntity();
...
void GUITransform2D::GUITextBoxRotation(Greet::Component* component,
                                        const std::string& before,
                                        const std::string& after)
{
  Entity e = entityManager->GetSelectedEntity();
