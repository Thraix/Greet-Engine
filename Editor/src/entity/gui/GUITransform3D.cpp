...
void GUITransform3D::Update(const Greet::Transform3DComponent& transform)
{
  // Translation
  transform3D->GetComponentByName<TextBox>("translationX")
...
void GUITransform3D::GUITextBoxTranslation3DX(Greet::Component* component,
...
void GUITransform3D::GUITextBoxTranslation3DY(Greet::Component* component,
                                              const std::string& before,
                                              const std::string& after)
{
  if(!entityManager->GetSelectedEntity().HasComponent<Transform3DComponent>())
...
void GUITransform3D::GUITextBoxTranslation3DZ(Greet::Component* component,
                                              const std::string& before,
                                              const std::string& after)
{
  if(!entityManager->GetSelectedEntity().HasComponent<Transform3DComponent>())
...
void GUITransform3D::GUITextBoxScaling3DX(Greet::Component* component,
                                          const std::string& before,
                                          const std::string& after)
{
  if(!entityManager->GetSelectedEntity().HasComponent<Transform3DComponent>())
...
void GUITransform3D::GUITextBoxScaling3DY(Greet::Component* component,
                                          const std::string& before,
                                          const std::string& after)
{
  if(!entityManager->GetSelectedEntity().HasComponent<Transform3DComponent>())
...
void GUITransform3D::GUITextBoxScaling3DZ(Greet::Component* component,
                                          const std::string& before,
                                          const std::string& after)
{
  if(!entityManager->GetSelectedEntity().HasComponent<Transform3DComponent>())
...
void GUITransform3D::GUITextBoxRotation3DX(Greet::Component* component,
                                           const std::string& before,
                                           const std::string& after)
{
  if(!entityManager->GetSelectedEntity().HasComponent<Transform3DComponent>())
...
void GUITransform3D::GUITextBoxRotation3DY(Greet::Component* component,
                                           const std::string& before,
                                           const std::string& after)
{
  if(!entityManager->GetSelectedEntity().HasComponent<Transform3DComponent>())
...
void GUITransform3D::GUITextBoxRotation3DZ(Greet::Component* component,
                                           const std::string& before,
                                           const std::string& after)
{
  if(!entityManager->GetSelectedEntity().HasComponent<Transform3DComponent>())
